...
namespace Hazel
{
	...
	{
		if(Input::IsKeyPressed(KeyCode::HZ_KEY_A))
			m_CameraPosition.x -= m_CameraMoveSpeed * deltaTime;
		else if(Input::IsKeyPressed(KeyCode::HZ_KEY_D))
			m_CameraPosition.x += m_CameraMoveSpeed * deltaTime;

		if(Input::IsKeyPressed(KeyCode::HZ_KEY_W))
			m_CameraPosition.y += m_CameraMoveSpeed * deltaTime;
		else if(Input::IsKeyPressed(KeyCode::HZ_KEY_S))
			m_CameraPosition.y -= m_CameraMoveSpeed * deltaTime;

		if (m_EnableRotation)
		{
			if(Input::IsKeyPressed(KeyCode::HZ_KEY_Q))
				m_CameraRotation += m_CameraRotateSpeed * deltaTime;
			else if(Input::IsKeyPressed(KeyCode::HZ_KEY_E))
				m_CameraRotation -= m_CameraRotateSpeed * deltaTime;
