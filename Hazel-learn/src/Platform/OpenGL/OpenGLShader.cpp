...
namespace Hazel
{
	...
	void OpenGLShader::CompileOrGetVulkanBinaries(const std::unordered_map<GLenum, std::string>& shaderSources)
	{
		...
		for (auto && [stage, source] : shaderSources)
		{
			...
			std::filesystem::path cachedPath = cacheDirection / (shaderFilePath.filename().string() + Utils::GLShaderStageCachedVulkanFileExtension(stage));
	...
	void OpenGLShader::CompileOrGetOpenGLBinaries()
	{
		...
		// compile vulkan spriv to opengl, store to m_OpenGLSPIRV
